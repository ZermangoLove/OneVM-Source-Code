...
namespace xVM.Helper.Core.ILAST
{
    ...
    {
        private readonly HashSet<CILBlock> BasicBlocks;
        ...
        private ILASTBuilder(MethodDef method, CilBody body, ScopeBlock scope)
        {
            ...
            BasicBlocks = new HashSet<CILBlock>(scope.GetBasicBlocks().Cast<CILBlock>().ToList());
        ...
        private void PopulateBeginStates(Stack<CILBlock> workList)
        {
            ...
            blockStates[BasicBlocks.ToList()[0]] = new BlockState
            {
                BeginStack = new ILASTVariable[0]
            };
            workList.Push(BasicBlocks.ToList()[0]);
