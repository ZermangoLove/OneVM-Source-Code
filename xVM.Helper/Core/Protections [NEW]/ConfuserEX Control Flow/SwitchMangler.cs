...
{
	internal class SwitchMangler : CEXManglerBase
	{
		...
		LinkedList<Instruction[]> SpiltStatements(CEXInstrBlock block, Trace trace, CFContext ctx)
		{
		...
		public override void Mangle(CilBody body, CEXScopeBlock root, CFContext ctx)
		{
