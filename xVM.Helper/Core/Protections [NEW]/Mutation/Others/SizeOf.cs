            ...
            if (method.HasBody && method.Body.HasInstructions)
            {
                for (int i = 0; i < method.Body.Instructions.Count; i++)
                {
                    if (method.Body.Instructions[i].OpCode == OpCodes.Ldc_I4)
                    {
                        ...
                        Start(i, sub, calculado, method);
                    }
                }
            }
        }

        private static void Start(int i, int sub, int calculado, MethodDef method)
        {
            switch (sub)
            {
                case 1:
                    // CORRECT
                    Local local_1 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    Local local_2 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    Local local_3 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    Local local_4 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    ...
                    body.Instructions.Insert(i + 1, new Instruction(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(GCNotificationStatus))));
                    ...
                    body.Instructions.Insert(i + 5, new Instruction(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(SByte))));
                    ...
                    body.Instructions.Insert(i + 9, new Instruction(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(SByte))));
                    ...
                    body.Instructions.Insert(i + 13, new Instruction(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(SByte))));
                ...
                case 2:
                    // CORRECT
                    local_1 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    method.Body.Variables.Add(local_1);

                    body.Instructions.Insert(i + 1, new Instruction(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(char))));
                    body.Instructions.Insert(i + 2, new Instruction(OpCodes.Stloc_S, local_1));
                    body.Instructions.Insert(i + 3, new Instruction(OpCodes.Ldloc_S, local_1));
                    body.Instructions.Insert(i + 4, OpCodes.Add.ToInstruction());
                    break;
                case 3:
                    local_1 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    local_2 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    method.Body.Variables.Add(local_1);
                    method.Body.Variables.Add(local_2);
                    body.Instructions.Insert(i + 1, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(System.Int32))));
                    body.Instructions.Insert(i + 2, new Instruction(OpCodes.Stloc_S, local_1));
                    body.Instructions.Insert(i + 3, new Instruction(OpCodes.Ldloc_S, local_1));
                    body.Instructions.Insert(i + 4, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(byte))));
                ...
                case 4:
                    local_1 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    local_2 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    local_3 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    local_4 = new Local(method.Module.Assembly.ManifestModule.CorLibTypes.Object);
                    method.Body.Variables.Add(local_1);
                    method.Body.Variables.Add(local_2);
                    method.Body.Variables.Add(local_3);
                    method.Body.Variables.Add(local_4);
                    body.Instructions.Insert(i + 1, Instruction.Create(OpCodes.Add));
                    body.Instructions.Insert(i + 2, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(System.Decimal))));
                    ...
                    body.Instructions.Insert(i + 5, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(System.GCCollectionMode))));
                    body.Instructions.Insert(i + 6, new Instruction(OpCodes.Stloc_S, local_2));
                    body.Instructions.Insert(i + 7, new Instruction(OpCodes.Ldloc_S, local_2));
                    body.Instructions.Insert(i + 8, Instruction.Create(OpCodes.Sub));
                    body.Instructions.Insert(i + 9, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(System.Int32))));
                    body.Instructions.Insert(i + 10, new Instruction(OpCodes.Stloc_S, local_3));
                    body.Instructions.Insert(i + 11, new Instruction(OpCodes.Ldloc_S, local_3));
                    body.Instructions.Insert(i + 12, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(byte))));
                    ...
                    body.Instructions.Insert(i + 15, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(byte))));
                    ...
                    body.Instructions.Insert(i + 19, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(byte))));
                    ...
                    body.Instructions.Insert(i + 22, Instruction.Create(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(byte))));
                ...
                case 5:
                    ...
                    method.Body.Variables.Add(local_1);
                    method.Body.Variables.Add(local_2);
                    body.Instructions.Insert(i + 1, new Instruction(OpCodes.Sizeof, method.Module.Assembly.ManifestModule.Import(typeof(System.EnvironmentVariableTarget))));
