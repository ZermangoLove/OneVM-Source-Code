...
namespace xVM.Runtime.Execution.Internal
{
    internal static unsafe class TypedReferenceHelpers
    {
        ...
        {
            var dm = new DynamicMethod(string.Empty, typeof(void), new[] {typeof(TypedRefPtr)}, VMInstance.__ExecuteModule, true);
        ...
        {
            var dm = new DynamicMethod(string.Empty, typeof(void), new[] {typeof(void*), typeof(TypedRefPtr)}, VMInstance.__ExecuteModule, true);
            var gen = dm.GetILGenerator();
        ...
        {
            var dm = new DynamicMethod(string.Empty, typeof(void), new[] { typeof(object), typeof(TypedRefPtr) }, VMInstance.__ExecuteModule, true);
            var gen = dm.GetILGenerator();
        ...
        {
            var dm = new DynamicMethod(string.Empty, typeof(void), new[] { typeof(TypedRefPtr), typeof(TypedRefPtr) }, VMInstance.__ExecuteModule, true);
            var gen = dm.GetILGenerator();
