    ...
    internal static class DirectCall
    {
        ...
        public static MethodBase GetDirectInvocationProxy(MethodBase method)
        {
            ...
            lock(directProxies)
            {
                ...
                var dm = new DynamicMethod(string.Empty, retType, paramTypes, VMInstance.__ExecuteModule, true);
        ...
        public static TypedInvocation GetTypedInvocationProxy(MethodBase method, OpCode opCode, Type constrainType)
        {
            ...
            lock(typedProxies)
            {
                ...
                var dm = new DynamicMethod(string.Empty, typeof(object), new[] { typeof(VMContext), typeof(IReference[]), typeof(Type[]) }, VMInstance.__ExecuteModule, true);
                var gen = dm.GetILGenerator();
