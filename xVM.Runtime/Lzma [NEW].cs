...
internal static class Lzma
{
    ...
    //    readCnt = 0;
    //    while (readCnt < xVM.Runtime.Execution.Internal.SizeOfHelper.SizeOf(typeof(int)))
    //    {
    //        readCnt += s.Read(prop, readCnt, xVM.Runtime.Execution.Internal.SizeOfHelper.SizeOf(typeof(int)) - readCnt);
    //    }

    //    if (!BitConverter.IsLittleEndian)
    //    {
    //        var i = prop.GetLowerBound(0);
    //        var j = prop.GetLowerBound(0) + xVM.Runtime.Execution.Internal.SizeOfHelper.SizeOf(typeof(int)) - 1;
    //        var objArray = (Array)prop as object[];
    //        if (objArray != null)
    //        {
    //            while (i < j)
    //            {
    //                xVM.Runtime.Services.PreventEdit<byte> temp = (byte)objArray[i];
    ...
    //    long compressedSize = s.Length - 5 - xVM.Runtime.Execution.Internal.SizeOfHelper.SizeOf(typeof(int));
