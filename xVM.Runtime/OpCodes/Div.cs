...
{
    internal unsafe class DivDword : IOpCode
    {
        public byte Code => Constants.OPCODELIST[138];
    ...
    internal unsafe class DivQword : IOpCode
    {
        public byte Code => Constants.OPCODELIST[140];
    ...
    internal unsafe class DivR32 : IOpCode
    {
        public byte Code => Constants.OPCODELIST[142];
    ...
    internal unsafe class DivR64 : IOpCode
    {
        public byte Code => Constants.OPCODELIST[144];
