...
{
    internal unsafe class NorDword : IOpCode
    {
        public byte Code => Constants.OPCODELIST[96];
    ...
    internal unsafe class NorQword : IOpCode
    {
        public byte Code => Constants.OPCODELIST[98];
